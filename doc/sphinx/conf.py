...
def setup(app):
    sphinx.apidoc.main(['-f', #Overwrite existing files
                        ...
                        './../pystoned', #Main Module directory
                        ]
    )
...
project = u'pyStoNED'
copyright = u'2020, The pyStoNED authors'
...
latex_documents = [
    ('index', 'pyStoNED.tex', u'pyStoNED Documentation',
     author, 'manual'),
]
...
man_pages = [
    ('index', 'pyStoNED', u'pyStoNED Documentation',
     [author], 1)
]
...
texinfo_documents = [
    ('index', 'pyStoNED', u'pyStoNED Documentation',
     author, 'pyStoNED', 'One line description of project.',
     'Miscellaneous'),
]
