...
class CNLSZG1:
    ...
    def __init__(self, y, x, z, Cutactive, cet='addi', fun='prod', rts='vrs'):
        ...
        self.__model__.beta1 = Var(self.__model__.I,
                                   ...
                                   bounds=(0.0, None),
                                   doc='beta1')
        self.__model__.lamda1 = Var(self.__model__.K, doc='Zvalue1')
    ...
    def __regression_rule1(self):
        ...
        if self.cet == "addi":
            ...
            def regression_rule1(model, i):
                return log(self.y[i]) == log(model.frontier1[i] + 1) + sum(model.lamda1[k] * self.z[i][k] for k in model.K) + model.epsilon1[i]
